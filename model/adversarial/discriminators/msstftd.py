...
from model.conv import NormConv2d
from model.adversarial.discriminators.base import MultiDiscriminator, MultiDiscriminatorOutputType
...
class DiscriminatorSTFT(nn.Module):
    ...
    def __init__(self, filters: int, in_channels: int = 1, out_channels: int = 1,
                 ...
                 activation: str = 'LeakyReLU', activation_params: dict = {'negative_slope': 0.3}):
        super().__init__()
        ...
        self.spec_transform = torchaudio.transforms.Spectrogram(
            ...
            normalized=self.normalized, power=None)
